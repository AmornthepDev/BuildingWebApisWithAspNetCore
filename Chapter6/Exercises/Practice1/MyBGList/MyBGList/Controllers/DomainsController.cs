...
namespace MyBGList.Controllers
{
    ...
    public class DomainsController : ControllerBase
    {
        ...
        private readonly ILogger<DomainsController> _log;

        public DomainsController(ApplicationDbContext context, ILogger<DomainsController> log)
        {
            _context = context;
            _log = log;
        }
        ...
        public async Task<ActionResult<RestDTO<List<Domain>>>> Get([FromQuery] RequestDTO<DomainDTO> input)
        {
        ...
        public async Task<RestDTO<Domain?>> Delete(int id)
        {
            ...
            return new RestDTO<Domain?>()
            {
                ...
                Links = new List<LinkDTO>()
                {
                    new LinkDTO(Url.Action(null, "Domains", id, Request.Scheme)!, "self", "DELET")
                }
            };
        }
    }
